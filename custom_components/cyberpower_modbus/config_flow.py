...
"""Config flow for the CyberPower UPS Modbus integration."""
...
class CyberPowerModbusConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle CyberPower UPS Modbus config flow."""
